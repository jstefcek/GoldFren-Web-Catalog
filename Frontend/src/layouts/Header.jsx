        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              ...
              {/* Language selector */}
              <div className={`absolute right-0 mt-2 w-40 rounded-md shadow-lg bg-white ring-1 ring-gray-300 ring-opacity-5 focus:outline-none z-10 transition-all duration-200 ${isLanguageMenuOpen ? 'opacity-100 visible' : 'opacity-0 invisible'}`}>
                <div className="py-1">
                  {languages.map((lang) => (
                    <button
                        key={lang.code}
