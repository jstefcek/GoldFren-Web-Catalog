  ...
  switch (category) {
    ...
    case "hadicky":
      return {
        ...
        // Hadicka - detail_hadicek (delka, fitting_kontektoru_a, fitting_kontektoru_b, zapojeni_a, zapojeni_b)
        detail_hadickek: removeEmptyDictFromArray(formData.detail_hadickek || []),
