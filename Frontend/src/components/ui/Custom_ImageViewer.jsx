...
export function CustomImageViewer({ src, alt = "Preview image" }) {
    ...
    <>
      ...
      >
        <img
          src={src}
          alt={alt}
          className="max-w-[100px] sm:max-w-[120px] max-h-[80px] sm:max-h-[100px] rounded shadow object-contain"
          loading="lazy"
        />
      </button>
        ...
        >
          ...
          >
            <img
              src={src}
              alt={alt}
              className="max-w-[100vw] max-h-[90vh] object-contain rounded-md shadow-lg"
              loading="lazy"
            />
          </div>
        </div>
