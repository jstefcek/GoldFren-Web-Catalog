...
export default function BrakePadDetail({ category = "", apiUrl = null }) {
  ...
  const [prislusenstviData, setPrislusenstviData] = useState({});
  ...
  return (
    <div className="p-4 md:p-4 w-full mb-8">
      ...
      <h1 className="text-3xl font-bold text-gray-800 mb-4 mt-8">
        {t("prislusenstvi_title")} - {displayData(prislusenstviData.cislo_dilu)}
      </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-50 p-4 rounded-md">
              <DetailImage
                ...
                imageUrl={prislusenstviData.image}
                altText={`Brake disc image for ${displayData(prislusenstviData.cislo_dilu)}`}
            ...
            <div className="bg-gray-50 p-4 rounded-md">
              <DetailImage
                ...
                imageUrl={prislusenstviData.vektor}
                altText={`Brake disc technical image for ${displayData(prislusenstviData.cislo_dilu)}`}
                noImageText={t("datagrid.no_image") || "No image available"}
              />
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-4 rounded-md">
            <div className="grid grid-cols-1 grid-cols-2 grid-cols-3 gap-6">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  {capitalFirstChar(displayData(prislusenstviData.typ))}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700">
                  {displayData(prislusenstviData.poznamka)}
                </p>
              </div>
              ...
              <div>
                <h3 className="text-lg font-medium mb-2">
                  {t("datagrid.description")}
                </h3>
                <p className="text-gray-700">
                  {displayData(prislusenstviData.popis)}
                </p>
              </div>
      ...
      <div className="rounded-lg shadow border border-gray-200 bg-white p-6">
        ...
        {showVehicles ? (
          <div className="mt-4">
            <DataGrid
              category="prislusenstvi_vozidla"
              apiUrl={`${serverUrl}/api/goldfren/internal/prislusenstvi/vozidla?limit=0&prislusenstvi_id=${prislusenstviData.id}`}
            />
          </div>
        ) : (
