...
export default function BrakePadDetail({ category = "", apiUrl = null }) {
  ...
  if (isValidId) {
    trackSortimentItemView({ sortiment_category: "adaptery", sortiment_id: id });
  }
        ...
        <div className="lg:w-full rounded-lg shadow border border-gray-200 bg-white p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <DetailImage
              ...
              altText={`Caliper image for ${displayData(
            ...
            <DetailImage
              ...
              altText={`Caliper technical image for ${displayData(
                adapterData.cislo_dilu
              )}`}
              noImageText={t("datagrid.no_image") || "No image available"}
            />
        ...
        <div className="lg:w-full rounded-lg shadow border border-gray-200 bg-white p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <p className="text-gray-700">{displayData(adapterData.prumer)}</p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700">
                {displayData(adapterData.typ_uchyceni)}
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700">
                {displayData(adapterData.pocet_pistku)}
              </p>
            </div>
          </div>
        </div>
        ...
        {showVehicles ? (
          <div className="mt-4">
            <DataGrid
              ...
              apiUrl={`${serverUrl}/api/goldfren/internal/adaptery/vozidla?adapter_id=${adapterData.id}`}
            />
          </div>
        ) : (
