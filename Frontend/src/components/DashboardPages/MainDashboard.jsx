    ...
    <div className="min-h-auto px-4 sm:px-6 lg:px-8 bg-gray-50">
      ...
      <div className="bg-white rounded-lg shadow-sm p-8">
        ...
        <p className="text-gray-600 text-lg">
          Vítejte na administrační stránce webu GOLDfren katalog!
        </p>
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 lg:col-span-1">
            ...
            <p className="text-gray-700 text-[48px] font-black">87</p>
          </div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 lg:col-span-1">
            ...
            <p className="text-gray-700 text-[48px] font-black">3613</p>
          </div>
